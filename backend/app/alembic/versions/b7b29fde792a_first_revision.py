...
def upgrade() -> None:
    ...
    sa.Column('analysis_risk_pct', sa.Float(), nullable=True),
    ...
    sa.Column('generic_routing_key', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['generic_routing_key'], ['stream_processors.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
